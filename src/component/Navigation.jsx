    ...
    <div className="fixed top-0 left-0 w-full z-[100]">
        ...
        <div className={`transition-transform duration-200 ${isOpen ? "translate-x-0" : "-translate-x-full"} fixed w-[15rem] sm:w-[22rem] h-full left-0 top-0 bg-gray-400/15 backdrop-blur-xl z-30`}>
            ...
            <ul className="mt-[.5rem] text-sm">
                ...
                <NavLink to="/policy" className={({ isActive }) => `${isActive ? "bg-primary-color border-b-blue-600" : "border-b-gray-400"} px-8 border-b mb-[1rem] block p-2 hover:bg-primary-color hover:border-b-blue-600`}>Terms Of Service</NavLink>
