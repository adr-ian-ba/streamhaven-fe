...
const ProfilePage = () => {
  ...
  const handleDeleteAccount = () => {
    toast.promise(
      apiHelper.deleteAuthorization("/auth/delete-account", token),
      {
  ...
  const handleDeleteAvatar = () => {
    toast.promise(
      apiHelper.deleteAuthorization("/user/delete-avatar", token),
      {
    ...
    <div className="background-color min-h-screen text-white py-20 px-4">
      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="mt-10 space-y-8">
          ...
          {/* Username Change */}
          <ChangeUsername onUpdate={(newName) => toast.success(`Username updated to ${newName}`)} />
          ...
          <div className="border-t border-gray-700 pt-6">
            ...
            <button
              className="bg-yellow-500 hover:bg-yellow-800 text-white px-4 py-2 rounded cursor-pointer"
            >
              <a href="https://saweria.co/StreamHavenOfficial">
                Donate Saweria
              </a>
            </button>
            </div>
